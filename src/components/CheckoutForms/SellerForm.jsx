...
export default function SellerForm() {
  ...
  const Step2 = () => {
    return (
      <div className="personalDetails">
        <span style={{ fontSize: "25px", marginBottom: "10px" }}>Company Details</span>
        <label>Company Name</label>
        <input name="companyName" placeholder="Enter Company Name" />
        <label>Company GSTIN No</label>
        <input name="companyGstinNo" placeholder="Enter Company GSTIN NO" />
        <label>Company Address Line1</label>
        <input name="addressLine1" placeholder="Enter Company Address" />
        <label>Company Address Line2</label>
        <input name="addressLine2" placeholder="Enter Company Address" />
        ...
        <input name="companyLandLineNo" placeholder="Enter Company Land-Line No" />
      </div>
    );
  };
  ...
  const steps = [
    ...
    { title: "Company Details", component: <Step2 /> },
